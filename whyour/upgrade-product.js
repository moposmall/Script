 ...
 * @Date: 2020-11-08 22:56:54
 * @LastEditors: whyour
 * @LastEditTime: 2020-11-30 13:12:52
 */
...
function getProductList(cookie) {
  return new Promise((resolve) => {
    $.get(taskUrl("smtg_productList", {}, cookie), (err, resp, data) => {
      try {
...
function unlockProduct(productId, cookie) {
  return new Promise((resolve) => {
    $.get(
      taskUrl("smtg_unlockProduct", { productId }, cookie),
      (err, resp, data) => {
        try {
          const {
            data: { bizCode, bizMsg, result },
